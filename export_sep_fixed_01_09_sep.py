...
CACHE_DB_PATH = os.path.join(HERE, "cache", "tracking_cache_wide_sep_01_09.db")
OLD_CACHE_DB = os.path.join(HERE, "cache", "tracking_cache_wide_sep_01_08.db")
...
def main():
    ...
    # Load wide range data (Aug 1 - Sep 9)
    detail_file = os.path.join(HERE, "tmp_wide_range_01_09_sep.xlsx")
    ...
    # Filter: CURRENT TIME or CREATED DATE must be within Sep 1 - Sep 9 2026 (midnight to midnight)
    ...
    sep_end   = pd.Timestamp("2026-09-09 23:59:59")
    ...
    print(f"[INFO] Bills in Sep 1-9 (00:00:00 to 23:59:59): {len(df_filtered)}")
    ...
    # Build Excel
    report_title = "ALL BILL TRACKING STATUS LOGS REPORT (PENDING & SHIPPED) — 01 TO 09 SEPTEMBER 2026"
    ...
    primary_new = r"C:\Users\DELL\Desktop\Bill_Tracking_Status_Logs_01Sep_09Sep_20260910_FIXED.xlsx"
    local_new   = os.path.join(HERE, "Bill_Tracking_Status_Logs_01Sep_09Sep_20260910_FIXED.xlsx")
    primary_old = r"C:\Users\DELL\Desktop\Bill_Tracking_Status_Logs_01Sep_08Sep_20260909_FIXED.xlsx"
    local_old   = os.path.join(HERE, "Bill_Tracking_Status_Logs_01Sep_08Sep_20260909_FIXED.xlsx")

    print(f"[INFO] Saving to primary: {primary_new}...")
    wb.save(primary_new)
    print(f"[SUCCESS] Saved: {primary_new}")

    for p in [local_new, primary_old, local_old]:
        try:
    ...
    print(f"\n[COMPLETE] Report ready — {len(all_results)} bills (Day 1-9, Midnight to Midnight)!")
